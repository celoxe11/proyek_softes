...
public class GetStartedTest extends BaseLandingTest {
    ...
    public void testGst002() {
        ...
        boolean urlCorrect = currentUrl.contains("upgrade-suitecrm") || currentUrl.contains("suitecrm.com/upgrade");
        assertTrue(urlCorrect,
    ...
    public void testGst005() {
        ...
        System.out.println("Downloaded file: " + (downloadedFileName != null ? downloadedFileName : "Not found"));
