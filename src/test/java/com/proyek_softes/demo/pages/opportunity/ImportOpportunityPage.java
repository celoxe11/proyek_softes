...
public class ImportOpportunityPage extends BaseImportPage {
    ...
    public ImportOpportunityPage(WebDriver driver) {
        super(driver);
    ...
    public void uploadFile(String fileName) {
        ...
        String resourcePath = Paths.get("src", "test", "resources", "opportunity_demo", fileName).toAbsolutePath().toString();
