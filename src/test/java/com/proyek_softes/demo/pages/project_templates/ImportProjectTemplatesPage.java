...
public class ImportProjectTemplatesPage extends BaseImportPage {
    ...
    public ImportProjectTemplatesPage(WebDriver driver) {
        super(driver);
    ...
    public boolean verifyDownloadedTemplateIsCSV(int timeoutSeconds, String screenshotName) {
        ...
        try {
            ...
            if (fileName != null) {
                return isTemplateFileInCSVFormat(fileName) && fileName.toLowerCase().contains("projects - templates");
            } else {
    ...
    public void uploadFile(String fileName) {
        ...
        String resourcePath = Paths.get("src", "test", "resources", "project_template_demo", fileName).toAbsolutePath().toString();
