...
public class ImportReportPage extends BaseImportPage {
    ...
    public ImportReportPage(WebDriver driver) {
        super(driver);
    ...
    public boolean verifyDownloadedTemplateIsCSV(int timeoutSeconds, String screenshotName) {
        ...
        try {
            ...
            if (fileName != null) {
                return isTemplateFileInCSVFormat(fileName) && fileName.toLowerCase().contains("reports");
            } else {
    ...
    public void uploadFile(String fileName) {
        ...
        String resourcePath = Paths.get("src", "test", "resources", "report_demo", fileName).toAbsolutePath().toString();
