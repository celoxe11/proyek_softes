...
public class ImportTargetPage extends BaseImportPage {
    ...
    public ImportTargetPage(WebDriver driver) {
        super(driver);
    ...
    public boolean verifyDownloadedTemplateIsCSV(int timeoutSeconds, String screenshotName) {
        ...
        try {
            ...
            if (fileName != null) {
                return isTemplateFileInCSVFormat(fileName) && fileName.toLowerCase().contains("targets");
            } else {
    ...
    public void uploadFile(String fileName) {
        ...
        String resourcePath = Paths.get("src", "test", "resources", "target_demo", fileName).toAbsolutePath().toString();
