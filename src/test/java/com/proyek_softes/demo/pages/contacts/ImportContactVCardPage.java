...
public class ImportContactVCardPage {
    ...
    public ImportContactVCardPage(WebDriver driver) {
        this.driver = driver;
    ...
    public void uploadFile(String fileName) {
        ...
        String resourcePath = Paths.get("src", "test", "resources", "contact_demo", fileName).toAbsolutePath().toString();
