...
public class ImportContractPage extends BaseImportPage {
    ...
    public ImportContractPage(WebDriver driver) {
        super(driver);
    ...
    public boolean verifyDownloadedTemplateIsCSV(int timeoutSeconds, String screenshotName) {
        ...
        try {
            ...
            if (fileName != null) {
                return isTemplateFileInCSVFormat(fileName) && fileName.toLowerCase().contains("contracts");
            } else {
    ...
    public void uploadFile(String fileName) {
        ...
        String resourcePath = Paths.get("src", "test", "resources", "contract_demo", fileName).toAbsolutePath().toString();
