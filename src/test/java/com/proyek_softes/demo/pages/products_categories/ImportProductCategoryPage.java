...
public class ImportProductCategoryPage extends BaseImportPage {
    ...
    public ImportProductCategoryPage(WebDriver driver) {
        super(driver);
    ...
    public boolean verifyDownloadedTemplateIsCSV(int timeoutSeconds, String screenshotName) {
        ...
        try {
            ...
            if (fileName != null) {
                return isTemplateFileInCSVFormat(fileName) && fileName.toLowerCase().contains("products");
            } else {
    ...
    public void uploadFile(String fileName) {
        ...
        String resourcePath = Paths.get("src", "test", "resources", "product_category_demo", fileName).toAbsolutePath().toString();
