...
public class CreateCampaignSurveyPage {
    ...
    public CreateCampaignSurveyPage(WebDriver driver) {
        this.driver = driver;
    ...
    private void initializeInputLocators() {
        ...
        inputLocators.put("survey_id", By.id("survey_id"));
    ...
    public void clickSelectSurvey() {
        wait.until(ExpectedConditions.elementToBeClickable(selectSurveyButton)).click();
    }
