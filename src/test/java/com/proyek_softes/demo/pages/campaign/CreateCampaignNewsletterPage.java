...
public class CreateCampaignNewsletterPage {
    ...
    public CreateCampaignNewsletterPage(WebDriver driver) {
        this.driver = driver;
    ...
    private void initializeInputLocators() {
        ...
        // subscription section inputs
        inputLocators.put("subscriptionName", By.id("subscription_name"));
        inputLocators.put("subscriptionListId", By.id("wiz_step3_subscription_name_id"));
        inputLocators.put("unsubscriptionName", By.id("unsubscription_name"));
        inputLocators.put("unsubscriptionListId", By.id("wiz_step3_unsubscription_name_id"));
        inputLocators.put("testName", By.id("test_name"));
        inputLocators.put("testListId", By.id("wiz_step3_test_name_id"));

        // radio buttons for subscription lists (Default option)
        inputLocators.put("subscriptionDefaultRadio", By.xpath("//input[@name='wiz_subscriptions_def_type' and @value='1']"));
        inputLocators.put("unsubscriptionDefaultRadio", By.xpath("//input[@name='wiz_unsubscriptions_def_type' and @value='1']"));
        inputLocators.put("testDefaultRadio", By.xpath("//input[@name='wiz_test_def_type' and @value='1']"));

        // templates section inputs
    ...
    public void next(int step) {
        try {
            By buttonNext;
            switch (step) {
                case 1, 3 -> buttonNext = buttonNextStep1;
                case 2, 4 -> buttonNext = buttonNextStep2;
    ...
    public void addInformationFromData(java.util.Map<String, String> data) {
        try {
            ...
            /**
             * Step 2: Subscription Lists
             */
            // Select Default radio buttons for subscription lists
            selectDefaultRadioButton("subscriptionDefaultRadio");
            selectDefaultRadioButton("unsubscriptionDefaultRadio");
            selectDefaultRadioButton("testDefaultRadio");

            Thread.sleep(500);
            System.out.println("  → Selected default subscription lists");
            ...
            Thread.sleep(500);
            System.out.println("  → Filled marketing email details: " + data.get("marketingName"));
    ...
    private void selectDefaultRadioButton(String fieldKey) {
        By locator = inputLocators.get(fieldKey);
        if (locator != null) {
            try {
